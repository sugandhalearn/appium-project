 ...
 *  this class.
 */
public class CreateAppiumSessionCucumber {
	...
	public synchronized void androidDriver(String buildPath, Method methodName) throws MalformedURLException{
		...
		capabilities.setCapability("appPackage", "com.catify.catify");
		capabilities.setCapability("appActivity", "com.catify.catify.master.ui.MainActivity");
